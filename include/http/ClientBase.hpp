/**
 * @project apophniapp
 * @file include/http/ClientBase.hpp
 ...
 * @section DESCRIPTION
 *
 *  ClientBase.hpp : HTTP Client ( Modified from https://github.com/eidheim/Simple-Web-Server)
 *
 */

#ifndef _APN_HTTP_CLIENTBASE_HPP_
#define _APN_HTTP_CLIENTBASE_HPP_
...
#endif	/* _APN_HTTP_CLIENTBASE_HPP_ */
